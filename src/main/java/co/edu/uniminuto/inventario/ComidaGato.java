...
public class ComidaGato extends Productos{
    private String marca;
    private String tamaño;
    private String comidaEspecial;

    public ComidaGato (String codigo, String marca, double precio, String tamaño, String comidaEspecial, String descripcion, int cantidad) {
        this.codigo = codigo;
        this.marca = marca;
        this.precio = precio;
        this.tamaño = tamaño;
